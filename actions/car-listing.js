...
export async function getCars({
  ...
  try {
    ...
    // Start by filtering only available cars.
    let where = {
      status: "AVAILABLE",
    };
    // Matches if the keyword appears in any of these fields
    if (search) {
      where.OR = [
    ...
    // Add price range greater than or equal to minPrice
    where.price = {
